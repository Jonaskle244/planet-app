...
export const satelliteOrbitConfigs: Record<string, SatelliteOrbitConfig> = {
  ...
  iapetus: {
    ...
    displaySemiMajorAxis: 4.35,
    eccentricity: 0.028,
    inclination: 7.6,
    longitudeOfAscendingNode: 86.5,
    argumentOfPeriapsis: 254.5,
    meanAnomalyAtEpoch: 74.8,
    orbitalPeriod: 79.331002,
  },
  titania: {
    semiMajorAxisKm: 436298,
    displaySemiMajorAxis: 2.55,
    eccentricity: 0.002,
    inclination: 0.1,
    longitudeOfAscendingNode: 29.5,
    argumentOfPeriapsis: 184,
    meanAnomalyAtEpoch: 68.1,
    orbitalPeriod: 8.705869,
  },
  oberon: {
    ...
    eccentricity: 0.002,
    inclination: 0.1,
    longitudeOfAscendingNode: 76.8,
    argumentOfPeriapsis: 132.2,
    meanAnomalyAtEpoch: 143.6,
    orbitalPeriod: 13.463237,
  },
  miranda: {
